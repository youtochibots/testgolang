...
func TestGetMultiplicaByIDCornerZeroParameter1(t *testing.T) {
    // Switch to test mode so you don't get such noisy output
    gin.SetMode(gin.TestMode)
    ...
    // here is the same as one of the routes you defined in the router setup
    // block!
    req, err := http.NewRequest(http.MethodGet, "/v1/multiplica/1/0", nil)
    if err != nil {
        t.Fatalf("Couldn't create request: %v\n", err)
    }
...
func TestGetMultiplicaByIDCornerZeroParameter2(t *testing.T) {
    // Switch to test mode so you don't get such noisy output
    gin.SetMode(gin.TestMode)
    ...
    // here is the same as one of the routes you defined in the router setup
    // block!
    req, err := http.NewRequest(http.MethodGet, "/v1/multiplica/0/1", nil)
    if err != nil {
        t.Fatalf("Couldn't create request: %v\n", err)
    }
